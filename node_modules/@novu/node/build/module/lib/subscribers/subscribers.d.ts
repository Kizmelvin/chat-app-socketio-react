...
import { IGetSubscriberNotificationFeedParams, IMarkFields, IMarkMessageActionFields, ISubscriberPayload, ISubscribers, IUpdateSubscriberGlobalPreferencePayload, IUpdateSubscriberPreferencePayload } from './subscriber.interface';
...
export declare class Subscribers extends WithHttp implements ISubscribers {
    ...
    setCredentials(subscriberId: string, providerId: string, credentials: IChannelCredentials, integrationIdentifier?: string): Promise<AxiosResponse<any, any>>;
    ...
    getGlobalPreference(subscriberId: string): Promise<AxiosResponse<any, any>>;
    getPreferenceByLevel(subscriberId: string, level: PreferenceLevelEnum): Promise<AxiosResponse<any, any>>;
    ...
    updateGlobalPreference(subscriberId: string, data: IUpdateSubscriberGlobalPreferencePayload): Promise<AxiosResponse<any, any>>;
    ...
    markAllMessagesAs(subscriberId: string, markAs: MessagesStatusEnum, feedIdentifier?: string | string[]): Promise<AxiosResponse<{
        data: number;
    }>>;
