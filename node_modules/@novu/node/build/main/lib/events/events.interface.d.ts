export interface IEvents {
    trigger(workflowIdentifier: string, data: ITriggerPayloadOptions): any;
    broadcast(workflowIdentifier: string, data: IBroadcastPayloadOptions): any;
    bulkTrigger(events: IBulkEvents[]): any;
    cancel(transactionId: string): any;
}
import { DigestUnitEnum, ITriggerPayload, TriggerRecipientSubscriber, TriggerRecipientsPayload, ITenantDefine, SmsProviderIdEnum } from '@novu/shared';
